...
<template>
    <Row background="light" v-if="hiredSalary != null">
        ...
        12).toLocaleString() }}/year, and is rising every year. </p>
                <p class="text-xl text-body mb-4">Outwork helped this company hire a <span
        ...
        savingsPercentage }}%.</p>
                <p class="text-xl text-body">Outwork charged the client 30% of the annual salary to recruit them a{{
        props.jobTitle }} - which came out to a ${{ (props.hiredSalary * .30 * 12).toLocaleString() }}
        ...
        props.hiredSalary * 12 - (props.hiredSalary * .30 * 12)).toLocaleString() }} just this
                        year.</span>
                </p>
